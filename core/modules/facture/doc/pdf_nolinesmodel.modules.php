...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_nolinesmodel.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate customers invoices from nolinesmodel model
 */
...
/**
 *	Class to generate the customer invoice PDF with template nolinesmodel
 */
class pdf_nolinesmodel extends ModelePDFFactures
{
	 /**
	...
	public function __construct($db)
	{
		...
		// Translations
		$langs->loadLangs(array("main", "bills", "nolinesmodel@nolinesmodel"));

		$this->db = $db;
		$this->name = "nolinesmodel";
		$this->description = $langs->trans('Module19054300Desc');
