...
/**
 *	\file       htdocs/core/modules/commande/doc/pdf_nolinesmodel.modules.php
 *	\ingroup    commande
 *	\brief      File of Class to generate PDF orders with template nolinesmodel
 */
...
/**
 *	Class to generate PDF orders with template nolinesmodel
 */
class pdf_nolinesmodel extends ModelePDFCommandes
{
	/**
	...
	public function __construct($db)
	{
		...
		// Translations
		$langs->loadLangs(array("main", "bills", "products", "nolinesmodel@nolinesmodel"));
